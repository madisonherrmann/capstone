...
:::{.notes}
 Here is an example of some the survey questions asked regarding geolocation. Participants reported frequently visited locations and were asked various questions regarding their risk level, alcohol availability, and valence. Their time spent at these locations was documented using gps monitoring via smartphone. Using data from our alcohol use disorder sample, we can begin to understand the need for continuous monitoring in recovery
:::
