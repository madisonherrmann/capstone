...
:::{.notes}
Future efficacy asked participants how likely are you to drink within the next week, on a scale from 1-10? On average, reports of high likelihood were associated with a higher probability of lapsing. their lapse probability increased.Past use refers to an EMA item that assessed Hence, if someone reported past use the day prior, their lapse probability for the next-day will be higher. Now that we have a sense of how these features can predict lapse risk, let's see how they vary across individuals and time. 
:::
