...
:::{.notes}
Through the addition of geolocation features, we can gain insight into not only when an individual is at a higher risk of lapsing, but why. Geolocation is a form of passive sensing that can provide context into the places and situations impacting lapse risk. The image shows an example of some of the survey questions asked regarding geolocation. Participants self-reported frequently visited locations and were asked various questions regarding previous drinking, alcohol availability, valence, and more. Their time spent at these locations was documented using gps monitoring via smartphone. Lets look at data from our alcohol use disorder study to better understand the need for continuous monitoring in recovery. 
:::
...
:::{.notes}
Past use refers to reported drinking days since the participants' last EMA. The feature values on the x-axis reveal how important past use is across participants, classified as low, medium, or high. Drawing your attention to the y-axis, observations below zero are decreasing lapse probability, while observations above zero are increasing it.There is a mostly linear relationship with past use and increased lapse risk.
:::
...
:::{.notes}
In the beginning, this participant had little change in their risk features, with past use and future efficacy bringing down their probability of lapse. The other features are staying constant at zero, indicating little to no influence on lapse risk. However, around day 35, past use, the blue line, drives up their lapse risk considerably. This increase coincides with the slight increase in time spent at a risky location, as shown with the purple line. Risky location provides insights into why this individual may have lapsed, as they likely visited to a bar and drank alcohol. Moreover, future efficacy, the yellow-green line, is shown closely lagging behind past use. This makes sense as a person who is currently using is likely to feel less confident about future abstinence. Around day 50, the future risky situation feature decreases their lapse risk, acting as a protective feature at certain points. This participant likely reported a low likelihood of risky situations in the next week. Let's now compare with another individual to highlight the need for personalized supports.
:::
