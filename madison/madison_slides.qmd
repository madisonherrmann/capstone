...
-however there are many barriers to accessing continued care in the US, like affordability and availability. 
...
- Early warning sign for relapse
...
- They're an important target for intervention and serve as an early warning sign for relapse because they both precede and predict it.
- A single lapse can be detrimental resulting in overdose and death, emphasizing the need for a risk-prediction model to predict future lapse probability. 
::: 
...
:::{.notes} 
Data was collected on 151 individuals with moderate to severe AUD in early stages of recovery. The majority of participants reported over 10 symptoms of AUD and comitted to abstinence for the duration of the study.
:::
