...
SUD's are chronic, requiring lifelong management, however there are many barriers to accessing continued care in the United States. These barriers include, but are not limited to, affordability, accessibility,**talk ab stigmatization of suds and why these lead to further disparities/gaps in care.** Our aim is to implement a risk-monitoring system that can deliver real-time interventions and improve clinical outcomes, while mitigating barriers in accessibility. 
