...
**insert plots** ::: {.notes} Data was collected on 151 individuals with moderate to severe AUD in early stages of recovery. Ecological momentary assessment data was collected on individual's in early recovery from alcohol use disorder. These refer to 4x daily self-report measures that assess mood, experiences, and past use. Geolocation and cellular communication data was also collected through passive sensing methods. ::: \## SHAP values
